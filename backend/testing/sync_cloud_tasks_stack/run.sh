...
# Java, then make Homebrew's keg-only OpenJDK usable without profile changes.
...
# Generate an ephemeral Firebase config so this gauntlet cannot collide with a
# developer emulator or another worktree.
